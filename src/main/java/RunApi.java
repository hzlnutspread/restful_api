...
public class RunApi {
    public static void main(String[] args) throws Exception {
        ...
        transcript.setAudioUrl("https://github.com/johnmarty3/JavaAPITutorial/blob/main/Thirsty.mp4?raw=true");
...
// System.out.println(Arrays.toString(transcript.getWords()));